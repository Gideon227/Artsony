    ...
    return (
        <div className='border border-gray-50 rounded-2xl bg-white w-full'>
            ...
            <div className='pt-12 px-8 overflow-y-scroll gap-y-4 flex flex-col'>
                ...
                <div className='bg-secondary-50 p-6 gap-y-6 border rounded-xl'>
                    <div className='flex flex-col gap-y-2 '>
                        <div className='flex gap-x-3 items-center'>
                            <p className='font-poppins font-medium text-heading text-body-s leading-6 tracking-wide'>Deactivate Account</p>
                            <Image src='/icons/question-circle.svg' width={20} height={20} alt='question mark' className=''/>
                        </div>
                        <p className='font-poppins text-body text-body-xs leading-6 tracking-wide'>
                            Deactivating your account will temporarily disable your Artsony profile and activity. <br /><br />
                            While deactivated, your profile won&apos;t be visible, you won&apos;t be able to buy or sell artworks, and notifications will be paused. Your account data, order history, and wallet balance will be kept safe until you return.<br /><br />
                            You can reactivate your account anytime by logging back in.
                        </p>
                        <Button variant='outline' size='md'>Continue</Button>
                    </div>
                    ...
                    <div className='flex flex-col gap-y-2 '>
                        ...
                        <p className='font-poppins text-body text-body-xs leading-6 tracking-wide'>
                            ...
                            Once deleted, you will no longer be able to sign in or recover your account, settings, or history. This action cannot be undone.<br /><br />
                            If your are a seller before deleting your account, make sure all orders are completed or resolved. If your account has a remaining balance, you&apos;ll need to withdraw those funds first.
